...
apply_patch "$top/patches/fix-prebuilt-tbb-link.patch" "$OPENVDB_SOURCE_DIR"

pushd "$OPENVDB_SOURCE_DIR"
    case "$AUTOBUILD_PLATFORM" in
        ...
        darwin*)
            ...
            lipo -create -output "$stage/lib/release/libopenvdb.a" "$stage/lib/release/x86_64/libopenvdb.a" "$stage/lib/release/arm64/libopenvdb.a"
        ;;
    ...
    cp LICENSE "$stage/LICENSES/openvdb.txt"
popd
